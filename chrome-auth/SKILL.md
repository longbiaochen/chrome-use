...
6. Keep the same debug endpoint and profile for the entire auth flow.
...
### `scripts/open_url.sh`
Starts or reuses the dedicated profile and opens the workflow URL (or resolved fallback).
